export const translations = {
  en: {
    ...
    articles: {
      ...
      body: 'Essays and data-informed commentary on economics, politics, public policy and decision-making.',
    ...
    articleDetail: {
      ...
      byline: 'By',
      excerpt: 'Summary',
      relatedProject: 'Related analysis',
      repo: 'Repository',
      ctaRepo: 'GitHub',
      project: 'View interactive analysis',
      readOnLinkedIn: 'LinkedIn article',
      ...
      x: 'X',
      email: 'Email',
      authorCard: 'About the author',
      projectCardEyebrow: 'Data-driven research',
      projectCardTitle: 'This article is part of a data-driven research project',
      projectCardBody: 'The editorial argument and the technical project are documented separately so the sources, processed files, charts and limitations can be reviewed together.',
      methodologyNote: 'These indicators are descriptive and do not, on their own, constitute a causal estimate of the tax’s effect.',
      continueReading: 'Continue exploring',
      linksPending: 'Related links will be added when verified.',
      relatedCtas: {
        nlpAnalysis: 'View NLP analysis',
        relatedAnalysis: 'View related analysis',
        fullArticle: 'Read full article',
      },
      notFoundTitle: 'Article not found',
      notFoundBody: 'The article you are looking for is not available.',
    },
    projects: {
  ...
  es: {
    ...
    articles: {
      ...
      body: 'Ensayos y comentarios basados en datos sobre economía, política, política pública y toma de decisiones.',
    ...
    articleDetail: {
      ...
      byline: 'Por',
      excerpt: 'Resumen',
      relatedProject: 'Análisis relacionado',
      repo: 'Repositorio',
      ctaRepo: 'GitHub',
      project: 'Ver análisis interactivo',
      readOnLinkedIn: 'Artículo en LinkedIn',
      ...
      x: 'X',
      email: 'Correo',
      authorCard: 'Sobre el autor',
      projectCardEyebrow: 'Investigación con datos',
      projectCardTitle: 'Este artículo hace parte de una investigación con datos',
      projectCardBody: 'El argumento editorial y el proyecto técnico están documentados por separado para que puedan revisarse juntos las fuentes, los archivos procesados, los gráficos y las limitaciones.',
      methodologyNote: 'Estos indicadores son descriptivos y no constituyen por sí solos una estimación causal del efecto del impuesto.',
      continueReading: 'Seguir explorando',
      linksPending: 'Los enlaces relacionados se agregarán cuando estén verificados.',
      relatedCtas: {
        nlpAnalysis: 'Ver análisis NLP',
        relatedAnalysis: 'Ver análisis relacionado',
        fullArticle: 'Leer artículo completo',
      },
      notFoundTitle: 'Artículo no encontrado',
      notFoundBody: 'El artículo que buscas no está disponible.',
    },
    projects: {
